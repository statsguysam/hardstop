...
A separate clean committed-source export imported the portable release bundle and loaded the CLI without credentials. Remote CI is a separate check after publication.
