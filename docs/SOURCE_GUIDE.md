...
[The Harbor catalog](../fixtures/examples/harbor-catalog.json) provides a longer fictional format example. Its JSON alone is not a runnable source package; the referenced recordings must also exist.
